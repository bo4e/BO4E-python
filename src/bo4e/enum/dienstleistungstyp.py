...
_dienstleistungstyp = {
    ...
    "DATENBEREITSTELLUNG_HISTORISCHE_LG": "DATENBEREITSTELLUNG_HISTORISCHE_LG",  # Datenbereitstellung historischer Lastgänge
    "DATENBEREITSTELLUNG_STUENDLICH": "DATENBEREITSTELLUNG_STUENDLICH",  # Datenbereitstellung stündlich
    "DATENBEREITSTELLUNG_VIERTELJAEHRLICH": "DATENBEREITSTELLUNG_VIERTELJAEHRLICH",  # Datenbereitstellung vierteljährlich
    "DATENBEREITSTELLUNG_HALBJAEHRLICH": "DATENBEREITSTELLUNG_HALBJAEHRLICH",  # Datenbereitstellung halbjährlich
    "DATENBEREITSTELLUNG_MONATLICH_ZUSAETZLICH": "DATENBEREITSTELLUNG_MONATLICH_ZUSAETZLICH",  # Datenbereitstellung monatlich zusätzlich
    "DATENBEREITSTELLUNG_EINMALIG": "DATENBEREITSTELLUNG_EINMALIG",  # Datenbereitstellung einmalig
    "AUSLESUNG_2X_TAEGLICH_FERNAUSLESUNG": "AUSLESUNG_2X_TAEGLICH_FERNAUSLESUNG",  # Auslesung 2x täglich mittels Fernauslesung
    ...
    "AUSLESUNG_MONATLICH_FERNAUSLESUNG": "AUSLESUNG_MONATLICH_FERNAUSLESUNG",  # Auslesung monatlich bei mittels Fernauslesung
    ...
    "AUSLESUNG_FERNAUSLESUNG_ZUSAETZLICH_MSB": "AUSLESUNG_FERNAUSLESUNG_ZUSAETZLICH_MSB",  # Auslesung, mittels Fernauslesung, zusätzlich vom Messstellenbetreiber vorgenommen
