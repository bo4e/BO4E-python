...
class TypCom(StrEnum):
    ...
    REGIONALERPREISGARANTIE = "REGIONALERPREISGARANTIE"
    REGIONALERPREISSTAFFEL = "REGIONALERPREISSTAFFEL"
    REGIONALERAUFABSCHLAG = "REGIONALERAUFABSCHLAG"
    REGIONALERTARIFPREISPOSITION = "REGIONALERTARIFPREISPOSITION"
